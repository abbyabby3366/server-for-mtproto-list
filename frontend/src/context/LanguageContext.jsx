...
const translations = {
  ...
  "Usage Alert": "用量警報",
  "Heavy Traffic Alert (>= 5GB)": "高流量警報 (>= 5GB)",
  ...
  "Red background flags represent active account connections routing >= 5GB total data volume.": "紅色背景標記代表總數據流量大於或等於 5GB 的活躍帳戶連接。",
